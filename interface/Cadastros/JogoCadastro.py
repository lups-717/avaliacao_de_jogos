...
def criar_Jogo(id_valor, titulo_valor,descricao_valor,genero_valor,data_valor,empresa_id_valor):
    ...
    url = 'http://localhost:5000/api/jogos'
...
def cadastro_jogo():
    ...
    adicionar_btn = ttk.Button(frame, text="Adicionar Jogo", command=lambda: criar_Jogo(id_entry.get(),titulo_entry.get(),descricao_entry.get(),genero_entry.get(),data_entry.get(),empresa_id_entry.get()))
